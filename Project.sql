-- Transaction Data , Product data , Store Data 
...
(1, ' Speaker ', 'Electronics', 66.99),
(2, 'Iphone', 'Electronics', 1600.49),
(3, 'Tab', 'Electronics', 849.00),
(4, 'Earphones', 'Accessories', 100.99),
(5, 'Books', 'Stationery', 100.00),
(6, 'Protein Powder', 'Fitness', 299.00),
(7, 'Multivitemain Tablets ', 'Fitness', 299.00),
(8, 'Webcam', 'Accessories', 89.00),
(9, 'Dumbells', 'Fitness', 1299.00),
(10, 'Keyword', 'Electronics', 99.00);
...
(1, 'Sarah Mall Store', 'Hyderabad'),
(2, 'AMB Store', 'Kerala'),
(3, 'Gachibowli Outlet', 'Hyderabad'),
(4, 'Downtown Store', 'USA'),
(5, 'Green Square Plaza', 'NewYork');
